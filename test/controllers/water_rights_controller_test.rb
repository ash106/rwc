...
class WaterRightsControllerTest < ActionController::TestCase
  ...
  test 'post create is successful with valid attributes' do
    water_right_params = { number: '13-1138', flow_cfs: 10, flow_ac_ft: 1920, sole_supply_acres: 640, uses: 'Most Farm', change_application_number: 'a28259', proof_due_date: "2015-05-31", priority_date: "1972-07-17", external_link: "http://www.google.com/", user_id: @user.id }
