...
water_right = WaterRight.create!(number: '13-142', flow_cfs: 5.12, flow_ac_ft: 1860, sole_supply_acres: 620, place_of_use: 'Full Farm', change_application_number: 'a28264', proof_due_date: "2016-06-30")
...
water_right = WaterRight.create!(number: '13-146', flow_cfs: 8.7, flow_ac_ft: 2716.5, sole_supply_acres: 905.5, place_of_use: 'Full Farm', change_application_number: 'a28264', proof_due_date: "2016-06-30")
water_right.point_of_diversion_water_rights.create!(point_of_diversion_id: well.id)
water_right.point_of_diversion_water_rights.create!(point_of_diversion_id: well_two.id)
water_right = WaterRight.create!(number: '13-147', flow_cfs: 2.31, flow_ac_ft: 480, sole_supply_acres: 160, place_of_use: 'Full Farm', change_application_number: 'a28264', proof_due_date: "2016-06-30")
water_right.place_of_use_area_water_rights.create!(place_of_use_area_id: area_one.id)
water_right = WaterRight.create!(number: '13-155', flow_cfs: 7.4, flow_ac_ft: 0, sole_supply_acres: 0, place_of_use: 'Full Farm', change_application_number: 'a28264', proof_due_date: "2016-06-30")
water_right.place_of_use_area_water_rights.create!(place_of_use_area_id: area_two.id)
water_right = WaterRight.create!(number: '13-198', flow_cfs: 1.11, flow_ac_ft: 475.08, sole_supply_acres: 179.8, place_of_use: 'Sec 19 & 20')
water_right.point_of_diversion_water_rights.create!(point_of_diversion_id: stream.id)
water_right.place_of_use_area_water_rights.create!(place_of_use_area_id: area_three.id)
water_right = WaterRight.create!(number: '13-1138', flow_cfs: 10, flow_ac_ft: 1920, sole_supply_acres: 640, place_of_use: 'Most Farm', change_application_number: 'a28259', proof_due_date: "2015-05-31")
water_right.point_of_diversion_water_rights.create!(point_of_diversion_id: well.id)
water_right.place_of_use_area_water_rights.create!(place_of_use_area_id: area_one.id)
