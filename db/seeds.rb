...
logan = User.create!(email: 'riley@gmail.com', password: 'password')
logan.add_role :customer
itsamemario = User.create!(email: 'alex@gmail.com', password: 'wheatbox')
...
water_right = WaterRight.create!(number: '13-142', flow_cfs: 5.12, flow_ac_ft: 1860, uses: 'Full Farm', change_application_number: 'a28264', proof_due_date: "2016-06-30", priority_date: "1908-10-27", user_id: this_guy.id)
...
water_right = WaterRight.create!(number: '13-146', flow_cfs: 8.7, flow_ac_ft: 2716.5, uses: 'Full Farm', change_application_number: 'a28264', proof_due_date: "2016-06-30", priority_date: "1908-10-27", user_id: this_guy.id)
water_right.point_of_diversion_water_rights.create!(point_of_diversion_id: well.id)
water_right.point_of_diversion_water_rights.create!(point_of_diversion_id: well_two.id)
water_right = WaterRight.create!(number: '13-147', flow_cfs: 2.31, flow_ac_ft: 480, uses: 'Full Farm', change_application_number: 'a28264', proof_due_date: "2016-06-30", priority_date: "1908-10-27", user_id: this_guy.id)
water_right.place_of_use_area_water_rights.create!(place_of_use_area_id: area_one.id)
water_right = WaterRight.create!(number: '13-155', flow_cfs: 7.4, flow_ac_ft: 0, uses: 'Full Farm', change_application_number: 'a28264', proof_due_date: "2016-06-30", priority_date: "1908-10-27", user_id: this_guy.id)
water_right.place_of_use_area_water_rights.create!(place_of_use_area_id: area_two.id)
water_right = WaterRight.create!(number: '13-198', flow_cfs: 1.11, flow_ac_ft: 475.08, uses: 'Sec 19 & 20', proof_due_date: "2015-05-31", priority_date: "1972-07-17", user_id: this_guy.id)
water_right.point_of_diversion_water_rights.create!(point_of_diversion_id: stream.id)
water_right.place_of_use_area_water_rights.create!(place_of_use_area_id: area_three.id)
water_right = WaterRight.create!(number: '13-1138', flow_cfs: 10, flow_ac_ft: 1920, uses: 'Most Farm', change_application_number: 'a28259', proof_due_date: "2015-05-31", priority_date: "1972-07-17", user_id: this_guy.id)
water_right.point_of_diversion_water_rights.create!(point_of_diversion_id: well.id)
water_right.place_of_use_area_water_rights.create!(place_of_use_area_id: area_one.id)
...
water_right = WaterRight.create!(number: '57-3411', priority_date: "1880-01-01", change_application_number: 'a37915', proof_due_date: "2017-04-30", flow_ac_ft: 7040, uses: 'Municipal', comments: 'Board of Water Resources on this change', user_id: logan.id)
...
water_right = WaterRight.create!(number: '57-443', priority_date: "1940-09-05", change_application_number: 'a37915', proof_due_date: "2017-04-30", flow_cfs: 1.4, uses: 'Municipal', user_id: logan.id)
water_right.point_of_diversion_water_rights.create!(point_of_diversion_id: one.id)
water_right.point_of_diversion_water_rights.create!(point_of_diversion_id: two.id)
water_right.point_of_diversion_water_rights.create!(point_of_diversion_id: three.id)
water_right.point_of_diversion_water_rights.create!(point_of_diversion_id: four.id)
...
water_right.point_of_diversion_water_rights.create!(point_of_diversion_id: ten.id)
water_right.point_of_diversion_water_rights.create!(point_of_diversion_id: eleven.id)
water_right = WaterRight.create!(number: '57-10191', priority_date: "1908-10-27", change_application_number: 'a37915', proof_due_date: "2017-04-30", flow_ac_ft: 2465.36, uses: 'Municipal', user_id: logan.id)
water_right.point_of_diversion_water_rights.create!(point_of_diversion_id: one.id)
water_right.point_of_diversion_water_rights.create!(point_of_diversion_id: two.id)
water_right.point_of_diversion_water_rights.create!(point_of_diversion_id: three.id)
water_right.point_of_diversion_water_rights.create!(point_of_diversion_id: four.id)
...
water_right = WaterRight.create!(number: '57-10327', priority_date: "1972-06-13", change_application_number: 'a37441', proof_due_date: "2022-09-30", flow_ac_ft: 23.4, uses: 'Municipal', comments: "Proof due date is end of 50-yr period; seg'd from 57-7833", user_id: logan.id)
...
water_right = WaterRight.create!(number: '57-7839', priority_date: "1972-07-17", change_application_number: 'a38167', proof_due_date: "2017-08-31", flow_ac_ft: 25.856, uses: 'Municipal', user_id: logan.id)
water_right.point_of_diversion_water_rights.create!(point_of_diversion_id: two_one.id)
water_right.point_of_diversion_water_rights.create!(point_of_diversion_id: two_two.id)
water_right.point_of_diversion_water_rights.create!(point_of_diversion_id: two_three.id)
water_right.point_of_diversion_water_rights.create!(point_of_diversion_id: two_four.id)
